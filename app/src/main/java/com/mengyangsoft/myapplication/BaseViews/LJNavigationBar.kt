...
class LJNavigationBar : ViewGroup, View.OnClickListener {
    ...
    fun getViewByAction(action: Action): View {
        val view = findViewWithTag<View>(action)
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        mDividerView!!.layout(0, measuredHeight - mDividerView!!.measuredHeight, measuredWidth,
                measuredHeight)
    }
